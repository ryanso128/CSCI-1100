...
def print_info(x):
    if x<0:
        ...
        nextt=int(input('what would you like to do next?\n'
        ...
        if nextt==1:
            ...
            webbrowser.open('http://www.google.com/maps/place/{}'.format(x[3]))
        elif nextt==3:
            webbrowser.open('http://www.google.com/maps/dir/110+8th+Street/{}'.format(x[3]))
        else:
            x=0    
